...
public class Barang extends javax.swing.JFrame {
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                ...
                                .addComponent(txtNama, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 152, Short.MAX_VALUE)))))
    ...
    public void insert(String kode, String nama, String satuan, int stok, int stokmin){
        try {
            ...
            String kodeBarang = JOptionPane.showInputDialog(null, "Masukkan kode barang : ");

            // Mengecek kode barang di database apakah sudah ada atau belum
            String query = "SELECT * FROM barang WHERE kd_brg = '" + kodeBarang + "'";
            rs = stmt.executeQuery(query);

            // Jika kode barang sudah ada, maka akan menampilkan pesan : "Kode barang sudah digunakan!"
            if (rs.next()) {
    ...
    public void update(String kode, String nama, String satuan, int stok, int stokmin){
        try {
            ...
            if (choice == 0) {
                ...
                String newValue = JOptionPane.showInputDialog(null, "Masukkan nilai baru:");
